...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className='w-72 '>
      ...
      <aside
        className={`
          bg-[#F9F6F2] min-h-screen p-6 border-r border-gray-200
          w-60
          fixed top-0 left-0
      ...
      >
        <div className="flex items-center justify-between mb-10 md:mb-10">
          <div className="flex items-center">
            ...
            <h2 className="text-h5 font-bold text-primaryColor-900 ml-2 Open Sans Italic">
              UmugandaTech
            </h2>
          </div>
        ...
        <nav className="space-y-2 border-t border-gray-200 mt-4 md:mt-0">
