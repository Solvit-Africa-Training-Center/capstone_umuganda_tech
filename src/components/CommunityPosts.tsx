...
const CommunityPosts: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col justify-center items-center w-full">
      {/* Leader Header */}
      ...
      <div className={`max-w-5xl mx-auto px-6 ${user?.role?.toLowerCase() === 'leader' ? 'pt-8' : 'pt-24'} pb-12`}>
        ...
        <div className="text-center mb-12">
          <h1 className="text-h2 font-bold text-gray-900 mb-3">Welcome to the UmugandaTech Community Hub.</h1>
                        ...
                        <div className="flex items-center gap-4">
                          <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 ${
                              post.has_upvoted 
                                ? 'bg-primaryColor-900 text-white border border-primaryColor-200' 
