...
const links: { id: Page; path: string; label: string; Icon: React.ElementType }[] = [
  { id: 'dashboard', path: '/dashboard', label: 'Discover Projects', Icon: Search },
  { id: 'community', path: '/community', label: 'Community Hub', Icon: ClipboardCheck },
  { id: 'checkin', path: '/qr-scanner', label: 'Check-In', Icon: MessageCircle },
